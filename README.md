...
## Overview
The Object Push Profile server is used to receive object files (e.g vCard, Image, Text, etc.). Send object files from an OPP client (mobile phone or PC).


## Features demonstrated
- AIROC&#8482; Bluetooth&#174; OPP server APIs
- Handling of the AIROC&#8482; HCI UART protocol
- SDP configuration
...
4. From the Client Control UI, open the "WICED HCI" serial port to connect to the eval board.
5. From a peer application such as a  Windows PC or mobile phone, find and pair with the OPP Server app.
6. From the peer application, send a file to the OPP Server app.
